...
if (isset($_POST['R_Registrar'])) {
	...
	if ($datoVerificarCodigo->verificar==0) {
		$ingresar =$objCuenta->Registrar_Divsionaria($subcuenta,$codigo,$nombre);
...
<div class="page-header">
  <h1><i class="fa fa-search page-header-icon"></i>REGISTRAR DIVISIONARIA</h1>
</div> <!-- / .page-header -->
